...
<div class="form-container">
    ...
    <h1><spring:message code="project.new.title"/></h1>
    ...
    <form:form method="POST" modelAttribute="projectDto" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:select path="typeProjectId" items="${typeProjects}" multiple="false" itemValue="id" itemLabel="type" class="form-control input-sm"/>
                    <div class="has-error">
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <input type="submit" value="<spring:message code="project.new.submit"/>" class="btn btn-primary btn-sm">
            </div>
        </div>
    </form:form>
</div>
